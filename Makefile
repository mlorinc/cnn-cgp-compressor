...
CXXFLAGS := -pedantic -Wall -O3 -std=c++17 -fp-model fast=2 -msse4.2 -axAVX,CORE-AVX2 -DNDEBUG -D__DISABLE_COUT -D__ERROR_T=${ERROR_DATATYPE} ${CXXFLAGS_EXTRA} # -Wall -O3 -fopenmp -std=c++17
