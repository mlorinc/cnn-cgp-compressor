...
class SingleFilterZeroOutterExperiment(BaseExperiment):
    ...
    def __init__(self, experiment_folder: str, model: BaseModel, cgp: CGP, dtype=torch.int8, layer_name = "conv1") -> None:
        super().__init__(experiment_folder, SingleFilterZeroOutterExperiment.name, model, cgp, dtype)
...
def init(experiment_folder: str, model: BaseModel, cgp: CGP, dtype=torch.int8):
    return SingleFilterZeroOutterExperiment(experiment_folder, model, cgp, dtype)
