...
# cli.py: Define CLI arguments for layer_bypass experiment.
...
def get_argument_parser(parser: argparse._SubParsersAction):
    parser.add_argument("--input-layer-names", nargs="+", default=["conv1"], help="List of the input CNN layer names")
    parser.add_argument("--output-layer-names", nargs="+", default=["conv2"], help="List of the output CNN layer names")
