...
class ReversedSingleFilterExperiment(BaseExperiment):
    ...
    def __init__(self, experiment_folder: str, model: BaseModel, cgp: CGP, dtype=torch.int8) -> None:
        super().__init__(experiment_folder, ReversedSingleFilterExperiment.name, model, cgp, dtype)
...
def init(experiment_folder: str, model: BaseModel, cgp: CGP, dtype=torch.int8):
    return ReversedSingleFilterExperiment(experiment_folder, model, cgp, dtype)
